...
define('ember-app/enums/u-k-t-i-o-app-t-status', ['exports', 'ember-flexberry-data/utils/enum-functions'], function (exports, _enumFunctions) {
  ...
  exports.default = (0, _enumFunctions.createEnum)({
    VEkspluatacii: 'В эксплуатации',
    Prostaivaet: 'Простаивает',
    Neispravno: 'Неисправно',
    Spisano: 'Списано',
    VRemonte: 'В ремонте'
  });
});
...
define('ember-app/locales/ru/forms/u-k-t-i-o-app-dolzhnost-e', ['exports'], function (exports) {
  ...
  exports.default = {
    caption: 'Должность',
    'naimenovanie-caption': 'Наименование'
  };
});
...
define('ember-app/locales/ru/forms/u-k-t-i-o-app-oborudovanie-e', ['exports'], function (exports) {
  ...
  exports.default = {
    ...
    'invNomer-caption': 'Инвентарный номер',
    'naimenovanie-caption': 'Наименование',
    'harakteristiki-caption': 'Характеристики',
    'dataPokupki-caption': 'Дата покупки',
    'cena-caption': 'Цена',
    'status-caption': 'Статус',
    'tipOborudovaniya-caption': 'Тип оборудования',
    'sotrudnik-caption': 'Сотрудник'
  };
});
...
define('ember-app/locales/ru/forms/u-k-t-i-o-app-sotrudnik-e', ['exports'], function (exports) {
  ...
  exports.default = {
    ...
    'organizaciya-caption': 'Организация'
  };
});
...
define('ember-app/locales/ru/models/u-k-t-i-o-app-oborudovanie', ['exports'], function (exports) {
  ...
  exports.default = {
    projections: {
      OborudovanieE: {
        invNomer: {
          __caption__: 'Инвентарный номер'
        },
        naimenovanie: {
          __caption__: 'Наименование'
        },
        harakteristiki: {
          __caption__: 'Характеристики'
        },
        dataPokupki: {
...
define('ember-app/mixins/regenerated/models/u-k-t-i-o-app-dolzhnost', ['exports', 'ember-data', 'ember-cp-validations', 'ember-flexberry-data/utils/attributes'], function (exports, _emberData, _emberCpValidations, _attributes) {
  ...
  var defineProjections = exports.defineProjections = function defineProjections(modelClass) {
    modelClass.defineProjection('DolzhnostE', 'u-k-t-i-o-app-dolzhnost', {
      naimenovanie: (0, _attributes.attr)('Наименование', { index: 0 })
    });
...
define('ember-app/mixins/regenerated/models/u-k-t-i-o-app-oborudovanie', ['exports', 'ember-data', 'ember-cp-validations', 'ember-flexberry-data/utils/attributes'], function (exports, _emberData, _emberCpValidations, _attributes) {
  ...
  var Model = exports.Model = Ember.Mixin.create({
    ...
    dataPokupki: _emberData.default.attr('date', {
  ...
  var defineProjections = exports.defineProjections = function defineProjections(modelClass) {
    modelClass.defineProjection('OborudovanieE', 'u-k-t-i-o-app-oborudovanie', {
      invNomer: (0, _attributes.attr)('Инвентарный номер', { index: 0 }),
      naimenovanie: (0, _attributes.attr)('Наименование', { index: 1 }),
      harakteristiki: (0, _attributes.attr)('Характеристики', { index: 2 }),
      dataPokupki: (0, _attributes.attr)('Дата покупки', { index: 3 }),
      cena: (0, _attributes.attr)('Цена', { index: 4 }),
      status: (0, _attributes.attr)('Статус', { index: 5 }),
      tipOborudovaniya: (0, _attributes.belongsTo)('u-k-t-i-o-app-tip-oborudovaniya', 'Тип оборудования', {
        naimenovanie: (0, _attributes.attr)('Наименование', { index: 7, hidden: true })
      }, { index: 6, displayMemberPath: 'naimenovanie' }),
      sotrudnik: (0, _attributes.belongsTo)('u-k-t-i-o-app-sotrudnik', 'Сотрудник', {
    ...
    modelClass.defineProjection('OborudovanieL', 'u-k-t-i-o-app-oborudovanie', {
      ...
      status: (0, _attributes.attr)('Статус', { index: 5 }),
      tipOborudovaniya: (0, _attributes.belongsTo)('u-k-t-i-o-app-tip-oborudovaniya', 'Тип оборудования', {
        naimenovanie: (0, _attributes.attr)('Тип оборудования', { index: 6 })
      }, { index: -1, hidden: true }),
      sotrudnik: (0, _attributes.belongsTo)('u-k-t-i-o-app-sotrudnik', 'Сотрудник', {
        fIO: (0, _attributes.attr)('Сотрудник', { index: 7 }),
...
define('ember-app/mixins/regenerated/models/u-k-t-i-o-app-organizaciya', ['exports', 'ember-data', 'ember-cp-validations', 'ember-flexberry-data/utils/attributes'], function (exports, _emberData, _emberCpValidations, _attributes) {
  ...
  var defineProjections = exports.defineProjections = function defineProjections(modelClass) {
    modelClass.defineProjection('OrganizaciyaE', 'u-k-t-i-o-app-organizaciya', {
      nazvanie: (0, _attributes.attr)('Название', { index: 0 })
    });
...
define('ember-app/mixins/regenerated/models/u-k-t-i-o-app-sotrudnik', ['exports', 'ember-data', 'ember-cp-validations', 'ember-flexberry-data/utils/attributes'], function (exports, _emberData, _emberCpValidations, _attributes) {
    ...
    */
    ...
    /**
      ...
      @example
        ...
        ```
    */
    _fIOCompute: function _fIOCompute() {
      var result = this.fIOCompute && typeof this.fIOCompute === 'function' ? this.fIOCompute() : null;
      this.set('fIO', result);
    },
  ...
  var defineProjections = exports.defineProjections = function defineProjections(modelClass) {
    modelClass.defineProjection('SotrudnikE', 'u-k-t-i-o-app-sotrudnik', {
      familia: (0, _attributes.attr)('Фамилия', { index: 0 }),
      imya: (0, _attributes.attr)('Имя', { index: 1 }),
      otchestvo: (0, _attributes.attr)('Отчество', { index: 2 }),
      tel: (0, _attributes.attr)('Телефон', { index: 3 }),
      email: (0, _attributes.attr)('Емейл', { index: 4 }),
      nomerKabineta: (0, _attributes.attr)('Номер кабинета', { index: 5 }),
      dolzhnost: (0, _attributes.belongsTo)('u-k-t-i-o-app-dolzhnost', 'Должность', {
        naimenovanie: (0, _attributes.attr)('Наименование', { index: 7, hidden: true })
      }, { index: 6, displayMemberPath: 'naimenovanie' }),
      organizaciya: (0, _attributes.belongsTo)('u-k-t-i-o-app-organizaciya', 'Организация', {
    ...
    modelClass.defineProjection('SotrudnikL', 'u-k-t-i-o-app-sotrudnik', {
      ...
      email: (0, _attributes.attr)('Емейл', { index: 4 }),
      nomerKabineta: (0, _attributes.attr)('Номер кабинета', { index: 5 }),
      dolzhnost: (0, _attributes.belongsTo)('u-k-t-i-o-app-dolzhnost', 'Наименование', {
        naimenovanie: (0, _attributes.attr)('Наименование', { index: 6 })
      }, { index: -1, hidden: true }),
      organizaciya: (0, _attributes.belongsTo)('u-k-t-i-o-app-organizaciya', 'Название', {
        nazvanie: (0, _attributes.attr)('Название', { index: 7 })
      }, { index: -1, hidden: true })
    });
  };
});
...
define('ember-app/models/u-k-t-i-o-app-dolzhnost', ['exports', 'ember-cp-validations', 'ember-flexberry-data/models/model', 'ember-flexberry-data/mixins/offline-model', 'ember-app/mixins/regenerated/models/u-k-t-i-o-app-dolzhnost'], function (exports, _emberCpValidations, _model, _offlineModel, _uKTIOAppDolzhnost) {
  ...
  var Validations = (0, _emberCpValidations.buildValidations)(_uKTIOAppDolzhnost.ValidationRules, {
    dependentKeys: ['model.i18n.locale']
  });

  var Model = _model.default.extend(_offlineModel.default, _uKTIOAppDolzhnost.Model, Validations, {});
...
define('ember-app/models/u-k-t-i-o-app-oborudovanie', ['exports', 'ember-cp-validations', 'ember-flexberry-data/models/model', 'ember-flexberry-data/mixins/offline-model', 'ember-app/mixins/regenerated/models/u-k-t-i-o-app-oborudovanie'], function (exports, _emberCpValidations, _model, _offlineModel, _uKTIOAppOborudovanie) {
  ...
  var Validations = (0, _emberCpValidations.buildValidations)(_uKTIOAppOborudovanie.ValidationRules, {
    dependentKeys: ['model.i18n.locale']
  });

  var Model = _model.default.extend(_offlineModel.default, _uKTIOAppOborudovanie.Model, Validations, {});
...
define('ember-app/models/u-k-t-i-o-app-organizaciya', ['exports', 'ember-cp-validations', 'ember-flexberry-data/models/model', 'ember-flexberry-data/mixins/offline-model', 'ember-app/mixins/regenerated/models/u-k-t-i-o-app-organizaciya'], function (exports, _emberCpValidations, _model, _offlineModel, _uKTIOAppOrganizaciya) {
  ...
  var Validations = (0, _emberCpValidations.buildValidations)(_uKTIOAppOrganizaciya.ValidationRules, {
    dependentKeys: ['model.i18n.locale']
  });

  var Model = _model.default.extend(_offlineModel.default, _uKTIOAppOrganizaciya.Model, Validations, {});
...
define('ember-app/models/u-k-t-i-o-app-sotrudnik', ['exports', 'ember-cp-validations', 'ember-flexberry-data/models/model', 'ember-flexberry-data/mixins/offline-model', 'ember-app/mixins/regenerated/models/u-k-t-i-o-app-sotrudnik'], function (exports, _emberCpValidations, _model, _offlineModel, _uKTIOAppSotrudnik) {
  ...
  var Validations = (0, _emberCpValidations.buildValidations)(_uKTIOAppSotrudnik.ValidationRules, {
    dependentKeys: ['model.i18n.locale']
  });

  var Model = _model.default.extend(_offlineModel.default, _uKTIOAppSotrudnik.Model, Validations, {});
...
define('ember-app/models/u-k-t-i-o-app-tip-oborudovaniya', ['exports', 'ember-cp-validations', 'ember-flexberry-data/models/model', 'ember-flexberry-data/mixins/offline-model', 'ember-app/mixins/regenerated/models/u-k-t-i-o-app-tip-oborudovaniya'], function (exports, _emberCpValidations, _model, _offlineModel, _uKTIOAppTipOborudovaniya) {
  ...
  var Validations = (0, _emberCpValidations.buildValidations)(_uKTIOAppTipOborudovaniya.ValidationRules, {
    dependentKeys: ['model.i18n.locale']
  });

  var Model = _model.default.extend(_offlineModel.default, _uKTIOAppTipOborudovaniya.Model, Validations, {});
...
define('UKTIO_App/config/environment', [], function() {
  var prefix = 'UKTIO_App';
try {
